Pod::Spec.new do |s|
  ...
  s.platform     = :ios, "7.0"
  s.source       = { :git => "https://github.com/vinnyoodles/MosaicLayout.git", :tag => "0.0.3" }
  s.source_files  = "MosaicCollectionView/*", "MosaicCollectionView/Libs/*", "MosaicCollectionView/Classes/*", "MosaicCollectionView/Resources/*"
  s.exclude_files = "MosaicCollectionView/*.png", "MosaicCollectionView/*.pch"
end
